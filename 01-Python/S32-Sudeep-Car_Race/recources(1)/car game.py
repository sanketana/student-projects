	...
	while run:
		...
		def iscollision(carx,cary,maincary,maincarx):
			...
			if distance<50:
				...
				return False
		coll1=iscollision(car1x,car1y,maincary,maincarx)
		coll2=iscollision(car2x,car2y,maincary,maincarx)
		coll3=iscollision(car3x,car3y,maincary,maincarx)
